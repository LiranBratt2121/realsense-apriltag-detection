...
def main():
    ...
    while True:
        ...
        debug_image = draw_depth(debug_image, tags, depth_image)
...
def draw_depth(image, tags, depth_image):
    for tag in tags:
        center = tag.center
        center = (int(center[0]), int(center[1]))

        depth = depth_image[center[1], center[0]]
        depth_text = f"Depth: {depth} mm"

        cv2.putText(image, depth_text, (center[0] - 50, center[1] + 30),
